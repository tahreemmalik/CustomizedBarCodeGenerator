  ...
  PDFPageView.prototype = {
    ...
    beforePrint: function PDFPageView_beforePrint() {
        ...
        if(this.isIE())
        {
            ...
            /* IE Printing Issue Fixation */

            var viewport = pdfPage.getViewport(2); //change
            ...
            canvas.style.width = (PRINT_OUTPUT_SCALE * Math.floor(viewport.width)) + 'px'; //change
            canvas.style.height = (PRINT_OUTPUT_SCALE * Math.floor(viewport.height)) + 'px'; //change
            ...
            var canvasWrapper = document.createElement('div');
            canvasWrapper.style.width = Math.floor(viewport.width) + 'px'; //change
            canvasWrapper.style.height = Math.floor(viewport.height) + 'px'; //change
            canvasWrapper.style.pageBreakAfter = 'always'; //add
...
var PDFViewerApplication = {
  ...
  error: function pdfViewError(message, moreInfo) {
    ...
    var errorWrapper = document.getElementById('errorWrapper');
    if (moreInfo && !moreInfo.contains('Unexpected server response  (414)'))
